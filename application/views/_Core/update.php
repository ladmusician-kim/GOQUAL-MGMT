                ...
                <div class="box box-info">
                    <form class="form-horizontal" action="<?=site_url('/core/update_submit')?>" method="post" id="frm">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?= site_url('/core/detail?coreid='.$item->_coreid)?>" class="btn btn-default pull-right" style="margin-right: 10px;">뒤로가기</a>
                            <a href="<?= site_url('/core/index')?>" class="btn btn-default pull-right" style="margin-right: 10px;">목록보기</a>
                        </div>
                    </form>
                </div>
            </div>
