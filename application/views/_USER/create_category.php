        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form class="form-horizontal" action="<?= site_url('/user/submit_category') ?>"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="label" class="col-sm-1 control-label">기본 사진</label>

                                <div class="col-sm-11">
                                    <input name="default_img" type="file" id="exampleInputFile">
                                </div>
                            </div>
                        </div>
